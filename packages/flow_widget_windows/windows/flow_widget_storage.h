#ifndef FLOW_WIDGET_WINDOWS_FLOW_WIDGET_STORAGE_H_
#define FLOW_WIDGET_WINDOWS_FLOW_WIDGET_STORAGE_H_
...
/// JSON file backed typed storage in %APPDATA%/flow_widget/.
...
#endif  // FLOW_WIDGET_WINDOWS_FLOW_WIDGET_STORAGE_H_
